...
const HelpContainerComp = ({ helpHover, helpContent }) => {
    ...
    return (
        <div className={`text-black w-96 h-max right-36 bg-white p-5 py-3 fixed z-20 transition-top ease-in-out duration-500 ${helpHover ? 'top-[75px]' : 'top-[-100%]'}`} ref={helpContent}>
            <ul>
